...
from experiments.models.learning_loss_models import LearningLossModel3, LearningLossModel3_1
...
for i in range(1, 2):
    for n_hidden in range(1, 2):
        ...
        ll_optimizer = optim.SGD(ll_model.parameters(), lr=1e-3)
        ...
        experiment = Experiment(
            ...
            random_seed=i,
            pool_size=POOL_SIZE,
            name='torch_topics_ll3.1_margin_bald_n_hidden' + str(n_hidden) + '_i2000_b20_q200_' + str(i),
            intermediate_state_saving=True,
            intermediate_state_filename='statistic/topics/torch_bn/ll3.1_margin_bald_n_hidden' + str(n_hidden) + 'inter_i2000_b20_q200_' + str(i),
        ...
        experiment.run()
        experiment.save_state('statistic/topics/torch_bn/ll3.1_margin_bald_n_hidden' + str(n_hidden) + '_i2000_b20_q200_test' + str(i))
