...
for i in range(1, 6):
    state = pickle.load(open('statistic/topics/torch/d128/passive_i2000_b20_' + str(i) + '.pkl', 'rb'))
    passive_accs.append(state['performance_history'])

    state = pickle.load(open('statistic/topics/torch/d128/least_confident_i2000_b20_' + str(i) + '.pkl', 'rb'))
    lc_accs.append(state['performance_history'])

    state = pickle.load(open('statistic/topics/torch/d128/margin_i2000_b20_' + str(i) + '.pkl', 'rb'))
    margin_accs.append(state['performance_history'])

    state = pickle.load(open('statistic/topics/torch/d128/entropy_i2000_b20_' + str(i) + '.pkl', 'rb'))
    entropy_accs.append(state['performance_history'])

#     state = pickle.load(open('statistic/topics/torch/cluster_by_concat_img_txt_i2000_b20_' + str(i) + '.pkl', 'rb'))
#     cluster_concat_accs.append(state['performance_history'])
#
#     state = pickle.load(open('statistic/topics/torch/cluster_by_img_i2000_b20_' + str(i) + '.pkl', 'rb'))
#     cluster_img_accs.append(state['performance_history'])
#     #
#     state = pickle.load(open('statistic/topics/torch/cluster_by_txt_i2000_b20_' + str(i) + '.pkl', 'rb'))
#     cluster_txt_accs.append(state['performance_history'])
#
# for j in range(1, 6):
#     for i in range(3, 6):
#         state = pickle.load(open('statistic/topics/torch/entropy_top_' + str(i) + '_i2000_b20_' + str(j) + '.pkl', 'rb'))
