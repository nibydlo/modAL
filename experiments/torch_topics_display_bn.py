...
for i in range(1, 2):
    ...
    state = pickle.load(open('statistic/topics/torch_bn/ll_ideal_margin_i2000_b20_q200_' + str(i) + '.pkl', 'rb'))
...
plot_conf_int(ll_ideal_accs, 2000, 20, 200, 'll ideal', color='C11')
