...
for i in range(1, 6):
    ...
    experiment = Experiment(
        ...
        random_seed=i,
        pool_size=POOL_SIZE,
        name='torch_topics_sud_trivial_encode_entropy_i2000_b20_q100_' + str(i),
        autoencoder=autoencoder,
        autoencoder_optim=autoencoder_optimizer
    )

    experiment.run()
    experiment.save_state('statistic/topics/torch/d128/sud_trivial_encode_entropy_i2000_b20_q100_' + str(i))
